...
#     slices = [dicom.read_file(path + '/' + s) for s in os.listdir(path)[1:]]
...
# data_dir = '/Users/juliamacmillan/Desktop/Kaggle/CNNData/'
# patients = os.listdir(data_dir)[2:]
# labels_df = pd.read_csv('/Users/juliamacmillan/Desktop/Kaggle/stage1_labels.csv', index_col=0)
#
